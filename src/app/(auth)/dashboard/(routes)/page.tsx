...
const dashboardCards = [
  ...
  { title: 'Gerar grades', icon: <AutoFixHighIcon /> },
  {
          ...
          {sidebarItems.map(({ label, icon }) => (
            <IconButton
              ...
              sx={{
                ...
                bgcolor: activeTab === label ? '#01013d' : 'transparent',
                border:
                  activeTab === label
                ...
                '&:hover': {
                  bgcolor:
                    activeTab === label ? '#01013d' : 'rgba(255,255,255,0.1)',
                },
              }}
            >
              {icon}
              ...
              {dashboardCards.map(({ title, icon }) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {React.cloneElement(
                        icon as React.ReactElement<SvgIconProps>,
                        {
